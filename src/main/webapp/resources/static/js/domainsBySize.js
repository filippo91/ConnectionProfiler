...
.controller('domainsBySize', ['$route', '$routeParams', '$scope', 'domainsDownloadFactory', '$rootScope', function($route, $routeParams, $scope, domainsDownloadFactory, $rootScope ) {
    ...
    .directive('usagePie',function(d3Service,legendShorterFilter){
        return {
            restrict: 'E',
                    ...
                    var drawPie = function(animation){
                        ...
                        pane.mousemove(function(e){
                            ...
                            div.transition()
                                .duration(200)
                                .style("opacity", .9);
                            div.html("<b>" + legendShorterFilter(d3.select(this).data()[0].data.server_domain) + "</b><br><i>Size: </i><b>" + f(d3.select(this).data()[0].value) +
